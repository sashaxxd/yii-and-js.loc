                    ...
                    <div id="wb_CssMenu1">
                        <ul>
                            <?php  foreach ($category as $item) :?>
                                <li class="firstmain"><a href="#" target="_self"><?= $item->name ?> <?= $item->id?></a>
                                </li>
                            <?php  endforeach; ?>
                        </ul>
                    </div>
    ...
    <div id="table_search">
        <div class="row">
            <div class="col-1">
                <table id="Table1">
                    <tr>
                        <td colspan="3" class="cell0"><span id="wb_uid7">&nbsp; </span><span id="wb_uid8"> iPad mini 2 retina / Не работает камера <?= $item->id?> </span></td>
                    </tr>
